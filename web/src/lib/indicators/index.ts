...
export function computeAll(candles: Candle[]) {
	...
	const ema200 = ema200a
		? +ema200a[ema200a.length - 1].toFixed(2)
		: null;
	...
	indicators.proCombo = calculateProCombo(
		candles,
		indicators,
		currentPrice,
	);
	indicators.compositeScore = indicators.proCombo
		? indicators.proCombo.score - 50
		: indicators.trend.bullishPct - 50;
